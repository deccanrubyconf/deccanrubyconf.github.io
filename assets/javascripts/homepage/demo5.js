!function (e) {
  ...
  27: function (e, t, n) {
    ...
    L.camera.position.z = 2, L.addBloomEffect({resolutionScale: .5, kernelSize: 4, distinction: .01}, 1);
    var C = new a.a("DeccanRubyConf", {color: "#FFFFFF", size: P.a.isMobile ? .08 : .1, wireframe: !0, opacity: 1});
    ...
    var q = ["#FFFAFF", "#0A2463", "#3E92CC", "#723bb7", "#ef5948","#efd28e", "#3f9d8c"].map(function (e) {
    ...
    H.to(".overlay", 2, {autoAlpha: 0}), H.fromTo(L.lookAt, 3, {y: -4}, {
      y: 0,
      ease: Power3.easeOut
      ...
      }), t.add(C.hide, 0), t.add(G.stop), t.to(".overlay", .5, {autoAlpha: 1, onComplete: e}, "-=1.5")
    })
  }
});
